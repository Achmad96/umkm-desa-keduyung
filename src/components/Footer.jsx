        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="mb-4 leading-relaxed font-body">
              Pusat informasi dan direktori produk unggulan dari para pelaku Usaha Mikro Kecil Menengah (UMKM) di Desa Keduyung.
            </p>
            <p className="text-[0.9rem] text-slate-400 font-body leading-relaxed">
              Balai Desa Keduyung<br />
              Kecamatan Laren, Kabupaten Lamongan<br />
          ...
          <div>
            <h3 className="font-heading text-white text-xl font-semibold mb-6 relative inline-block after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-10 after:h-0.5 after:bg-gold">
              Tautan Cepat
            </h3>
            <ul className="list-none flex flex-col gap-3 p-0 m-0">
              <li>
                <Link href="/" className="inline-block transition-all duration-200 hover:text-gold hover:translate-x-1">Beranda</Link>
              </li>
              <li>
                <Link href="/profil-desa" className="inline-block transition-all duration-200 hover:text-gold hover:translate-x-1">Profil Desa</Link>
              </li>
              <li>
                <Link href="/umkm" className="inline-block transition-all duration-200 hover:text-gold hover:translate-x-1">Direktori UMKM</Link>
              </li>
              <li>
                <Link href="/pendaftaran" className="inline-block transition-all duration-200 hover:text-gold hover:translate-x-1">Pendaftaran UMKM</Link>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-white/10 py-6 text-center mt-12">
        <div className="container mx-auto px-4">
          <p className="text-sm text-slate-500 m-0">
            © 2026 Kumpulan UMKM Desa Keduyung. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
