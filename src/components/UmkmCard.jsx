        ...
        <div className="flex gap-3 justify-end mt-auto">
          ...
          {phoneNumber && (
            <a 
              ...
              className="flex items-center justify-center w-11 h-11 rounded-full text-white transition-all duration-200 no-underline bg-primary-light hover:scale-110 hover:shadow-[0_4px_12px_rgba(42,74,127,0.4)]"
          ...
          {shopeeLink && (
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center justify-center w-11 h-11 rounded-full text-white transition-all duration-200 no-underline bg-[#EE4D2D] hover:scale-110 hover:shadow-[0_4px_12px_rgba(238,77,45,0.4)]"
              aria-label={`Shopee ${name}`}
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
          ...
          {tiktokLink && (
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center justify-center w-11 h-11 rounded-full text-white transition-all duration-200 no-underline bg-[#010101] hover:scale-110 hover:shadow-[0_4px_12px_rgba(1,1,1,0.4)]"
